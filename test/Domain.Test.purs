...
main = do
  runTest "Domain.testReroll" do
    assertTelegram
      ...
      [ "ev:{\"chat_id\":241854720,\"message_id\":2883,\"url\":\"_VIDEO_URL_\",\"keyboard\":[{\"callback_data\":\"5|reroll|puppy\",\"text\":\"🎲 🎲 🎲\"}]}" ]
  ...
  runTest "Domain.testDogCommand" do
    assertTelegram
      ...
      [ "sv:{\"chat_id\":241854720,\"reply_to_message_id\":null,\"url\":\"_VIDEO_URL_\",\"caption\":null,\"keyboard\":[{\"callback_data\":\"5|reroll|puppy\",\"text\":\"🎲 🎲 🎲\"}]}"
